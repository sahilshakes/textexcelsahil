...
public class B_Final
{
    ...
    public void testTransitiveReferences()
    {
        ...
        assertEquals("Fib(5)", TestsALL.Helper.format("5.0"), cell.abbreviatedCellText());
    ...
    public void testSumSingle()
    {
        ...
        assertEquals("sum single cell", TestsALL.Helper.format("37.05"), cell.abbreviatedCellText());
    }

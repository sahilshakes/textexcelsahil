...
public class ExtensionOperationOrder
{
    ...
    public void testSimplePrecedence()
    {
        ...
        String result = grid.getCell(new TestsALL.TestLocation(0, 0)).abbreviatedCellText();
    ...
    public void testComplexPrecedence()
    {
        ...
        String result = grid.getCell(new TestsALL.TestLocation(19, 11)).abbreviatedCellText();
    ...
    public void testReferencePrecedence()
    {
        ...
        String result = grid.getCell(new TestsALL.TestLocation(2, 0)).abbreviatedCellText();

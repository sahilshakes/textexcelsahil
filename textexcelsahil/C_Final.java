...
public class C_Final
{
    ...
    public void testSortaCol() 
    {
        ...
        assertEquals("0.01", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals("2.1", grid.getCell(new TestsALL.TestLocation(1,0)).fullCellText());
        assertEquals("19.1", grid.getCell(new TestsALL.TestLocation(2,0)).fullCellText());
        assertEquals("607.1", grid.getCell(new TestsALL.TestLocation(3,0)).fullCellText());
    }
    ...
    public void testSortaRow()
    {
        ...
        assertEquals("0.01", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals("2.2", grid.getCell(new TestsALL.TestLocation(0,1)).fullCellText());
        assertEquals("19.2", grid.getCell(new TestsALL.TestLocation(0,2)).fullCellText());
        assertEquals("607.2", grid.getCell(new TestsALL.TestLocation(0,3)).fullCellText());
    }
    ...
    public void testSortaRowExtraValues() 
    {
        ...
        assertEquals("0.01", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals( "2.4", grid.getCell(new TestsALL.TestLocation(0,1)).fullCellText());
        assertEquals("19.4", grid.getCell(new TestsALL.TestLocation(0,2)).fullCellText());
        assertEquals("607.4", grid.getCell(new TestsALL.TestLocation(0,3)).fullCellText());

        assertEquals("17.4", grid.getCell(new TestsALL.TestLocation(0,4)).fullCellText());
        assertEquals("3.14159", grid.getCell(new TestsALL.TestLocation(1,0)).fullCellText());
        assertEquals("\"extras!\"", grid.getCell(new TestsALL.TestLocation(1,1)).fullCellText());
    }
    ...
    public void testSortaTwoDimensionalOffset() 
    {
        ...
        assertEquals("0.01", grid.getCell(new TestsALL.TestLocation(2,2)).fullCellText());
        assertEquals("2.5", grid.getCell(new TestsALL.TestLocation(2,3)).fullCellText());
        assertEquals("19.5", grid.getCell(new TestsALL.TestLocation(3,2)).fullCellText());
        assertEquals("607.5", grid.getCell(new TestsALL.TestLocation(3,3)).fullCellText());

        assertEquals("17.5", grid.getCell(new TestsALL.TestLocation(0,4)).fullCellText());
        assertEquals("3.14159", grid.getCell(new TestsALL.TestLocation(1,0)).fullCellText());
    }
    ...
    public void testSortaTwoDimensional() 
    {
        ...
        assertEquals("0.01", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals("2.3", grid.getCell(new TestsALL.TestLocation(0,1)).fullCellText());
        assertEquals("19.3", grid.getCell(new TestsALL.TestLocation(1,0)).fullCellText());
        assertEquals("607.3", grid.getCell(new TestsALL.TestLocation(1,1)).fullCellText());
    }

...
public class C_Checkpoint1
{
    ...
    public void testSortaTextCol() 
    {
        ...
        assertEquals("\"airplanes\"", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals("\"babies\"", grid.getCell(new TestsALL.TestLocation(1,0)).fullCellText());
        assertEquals("\"rocks\"", grid.getCell(new TestsALL.TestLocation(2,0)).fullCellText());
        assertEquals("\"zest\"", grid.getCell(new TestsALL.TestLocation(3,0)).fullCellText());
    }
    ...
    public void testSortaTextRow()
    {
        ...
        assertEquals("\"aerospace\"", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals("\"bae\"", grid.getCell(new TestsALL.TestLocation(0,1)).fullCellText());
        assertEquals("\"rocking\"", grid.getCell(new TestsALL.TestLocation(0,2)).fullCellText());
        assertEquals("\"xylophone\"", grid.getCell(new TestsALL.TestLocation(0,3)).fullCellText());
    }
    ...
    public void testSortaTextRowExtraValues() 
    {
        ...
        assertEquals("\"acted\"", grid.getCell(new TestsALL.TestLocation(0,0)).fullCellText());
        assertEquals("\"acting\"", grid.getCell(new TestsALL.TestLocation(0,1)).fullCellText());
        assertEquals("\"branded\"", grid.getCell(new TestsALL.TestLocation(0,2)).fullCellText());
        assertEquals("\"branding\"", grid.getCell(new TestsALL.TestLocation(0,3)).fullCellText());
